...
public class StreamReduceExample {
    ...
    /**
     * Reduce Terminal operator takes a binaryOperator and unless used with an identity is com.learn.java.optional
     *
     * @param intList
     * @return
     */
    ...
    public static Optional<Student> getHighestGPA() {
        //no default value in reduce therefore com.learn.java.optional
